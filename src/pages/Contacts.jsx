...
const glass = "rounded-2xl p-4 bg-gray-950/10 backdrop-blur-sm border border-white/10 shadow-[0_10px_30px_rgba(0,0,0,0.25)]";
		...
		<div className="relative isolate min-h-screen">
			<div className="relative z-[1] px-4 pb-28 pt-4 font-semibold text-gray-900">
				<div className="mx-auto max-w-md">
					<h1 className="mb-6 text-center text-2xl font-bold tracking-tight text-gray-900">Контакты</h1>
					...
					<section className={`${glass} mb-4`}>
						<div className="flex flex-col items-center gap-3">
							...
							<p className="text-center text-sm leading-relaxed text-gray-600">
								Доставка из Китая в Беларусь. Пишите в соцсетях — ответим на вопросы по заказам и доставке.
							</p>
						</div>
					</section>

					<section className={`${glass} mb-4`}>
						<h2 className="mb-1 text-center text-base font-semibold text-gray-900">Telegram-канал</h2>
						<p className="mb-4 text-center text-xs leading-relaxed text-gray-600">Сканируйте QR или нажмите иконку ниже</p>
					...
					<section className={glass}>
						<h2 className="mb-4 text-center text-base font-semibold text-gray-900">Мы в соцсетях</h2>
							...
							{SOCIAL_LINKS.map((item) => {
								...
								return (
									<button
										...
										<span className="flex h-14 w-14 items-center justify-center rounded-2xl backdrop-blur-sm font-semibold text-gray-950 ring-1 ring-white/15 transition group-hover:bg-white/15 group-hover:ring-white/25">
