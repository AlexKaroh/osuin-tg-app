...
const FAQ_SECTIONS = [
	{
		...
		items: [
			{
				id: "pay-1",
				question: "Как оплатить заказ, если карты РБ/РФ не принимаются в Китае?",
				answer: "Мы берем на себя финансовую часть. Вы переводите оплату нам в местной валюте, а мы выкупаем товар со своего счета.",
			},
			{
				id: "pay-2",
	...
	},
	{
		...
		items: [
			...
			},
			{
				...
				answer: "Да, после отправки из Китая мы предоставляем трек-номер или обновляем статус вашего заказа в личном кабинете/чате.",
			},
			{
				id: "del-3",
	...
	},
	{
		...
		items: [
			...
			},
			{
				...
				answer: "Низкая цена — для «совместной покупки». Мы всегда выкупаем по этой цене, присоединяясь к существующим группам, чтобы вы экономили.",
			},
		],
	},
	{
		...
		items: [
			{
				...
				answer: "Скопируйте ссылку в приложении (кнопка Share/Поделиться) и пришлите нам вместе со скриншотом нужного цвета и размера.",
			},
			{
				id: "ord-2",
				question: "Нужен ли паспорт для получения посылки?",
				answer: "Если получение через почтовое отделение — да. Если личная встреча в Минске — достаточно номера заказа.",
			},
			{
				id: "ord-3",
		...
		items: [
			{
				...
				answer: "Оружие, наркотические средства, горючие жидкости, аккумуляторы большой мощности и культурные ценности.",
			},
			{
				id: "risk-2",
			...
			{
				id: "risk-5",
				question: "Можно ли объединить товары от разных продавцов в одну посылку?",
				answer:
...
const MARKETPLACES = [
	{
		...
		name: "Taobao",
		logo: logoTaobao,
		storeUrlIos: "https://apps.apple.com/by/app/taobao-online-shopping-app/id387682726",
		storeUrlAndroid: "https://market.m.taobao.com/app/fdilab/download-page/main/index.html",
	...
	},
	{
		...
		name: "Poizon",
		logo: logoPoizon,
		storeUrlIos: "https://apps.apple.com/by/app/%E5%BE%97%E7%89%A9-%E5%BE%97%E5%88%B0%E7%BE%8E%E5%A5%BD%E4%BA%8B%E7%89%A9/id1012871328",
	...
	},
	{
		...
		name: "1688",
		logo: logo1688,
		storeUrlIos: "https://apps.apple.com/by/app/1688-b2b-market/id507097717",
	...
	},
	{
		...
		logo: logoPinduoduo,
		storeUrlIos:
			"https://apps.apple.com/by/app/%E6%8B%BC%E5%A4%9A%E5%A4%9A-%E5%A4%9A%E5%A4%9A%E4%B9%B0%E8%8F%9C-%E7%99%BE%E4%BA%BF%E8%A1%A5%E8%B4%B4/id1044283059",
	...
	},
	{
		...
		name: "GooFish",
		logo: logoGoofish,
		storeUrlIos: "https://apps.apple.com/us/app/%E9%97%B2%E9%B1%BC-%E7%A5%9E%E5%A5%87%E7%9A%84%E9%97%B2%E9%B1%BC/id510909506",
		storeUrlAndroid: "https://play.google.com/store/apps/details?id=com.taobao.idlefish&hl=ru",
	...
	},
	{
		...
		name: "95",
		logo: logo95,
		storeUrlIos: "https://apps.apple.com/by/app/95%E5%88%86-%E6%AD%A3%E5%93%81%E9%97%B2%E7%BD%AE%E4%BA%A4%E6%98%93%E5%B9%B3%E5%8F%B0/id1488709429",
			...
			<motion.div
				...
				<div className="shrink-0 border-t border-[#EAECF0] bg-white px-5 pb-5 pt-4">
					<button
						...
						{storeIos ? <IconApple className="h-5 w-5 shrink-0 opacity-95" /> : <IconAndroid className="h-5 w-5 shrink-0 opacity-95" />}
						Скачать приложение
					</button>
				</div>
			</motion.div>
					...
					<div className="mt-4 flex items-stretch gap-0">
						<div className="min-w-0 flex-1 pr-3 sm:pr-4">
							<div className="mb-2 flex items-center gap-1.5 border-b border-[#EAECF0] pb-2">
								...
								<p className="text-[11px] font-semibold uppercase tracking-[0.2em] text-[#667085]">iOS</p>
							</div>
						...
						<div className="min-w-0 flex-1 pl-3 sm:pl-4">
							<div className="mb-2 flex items-center gap-1.5 border-b border-[#EAECF0] pb-2">
								...
								<p className="text-[11px] font-semibold uppercase tracking-[0.2em] text-[#667085]">Android</p>
							</div>
							<div className="space-y-2.5 text-sm">
								{items.map((item) => (
									<button
			...
			<motion.div
				...
				<div className="shrink-0 border-b border-[#EAECF0] bg-white px-5 pb-4 pt-5">
					<div className="flex items-start justify-between gap-3">
						<div className="min-w-0 pr-1">
							<h3 className="text-xl font-semibold text-[#101828]">Часто задаваемые вопросы</h3>
							<p className="mt-1 text-sm text-[#667085]">Нажмите на вопрос, чтобы открыть ответ</p>
						</div>
						<button
							type="button"
							onClick={onClose}
										...
										return (
											<div
												...
												<button
													...
													<span className="text-sm font-medium leading-snug text-[#101828]">{item.question}</span>
													<IconChevronDown
														className={`mt-0.5 h-5 w-5 shrink-0 text-[#667085] transition-transform duration-200 ${isOpen ? "rotate-180" : ""}`}
													/>
												</button>
												<div
													className={`grid transition-[grid-template-rows] duration-200 ease-out ${isOpen ? "grid-rows-[1fr]" : "grid-rows-[0fr]"}`}>
													<div className="min-h-0 overflow-hidden">
														<p className="border-t border-[#EAECF0]/80 px-4 pb-4 pt-3 text-sm leading-relaxed text-[#475467]">{item.answer}</p>
													</div>
												</div>
											</div>
										);
...
export default function Home() {
	...
	const isAnyModalOpen = isMarketplacesOpen || Boolean(selectedMarketplace) || isFaqOpen;
	...
	const getAccentColors = (accent) => {
		...
		return {
			from: fromMatch?.[1],
			to: toMatch?.[1],
			border: fromMatch?.[1], // можно поменять на to если хочешь
		};
	};
        ...
        ousin.logistics
				...
				<section className="mb-6">
					<div className="mb-3 flex items-center justify-between">
						<h2 className="text-xl font-semibold text-[#2f2f2f]">Маркетплейсы</h2>
						<button
							type="button"
								...
								<div className="flex gap-2 py-3 overflow-x-auto no-scrollbar">
									{page.map((item) => (
										<button
											...
											className={
												"flex max-h-[140px] max-w-[140px] min-w-[140px] flex-col overflow-hidden rounded-2xl shadow-md text-left backdrop-blur-sm border-2 transition duration-200 active:scale-[0.98]"
											}
											style={{ borderColor: getAccentColors(item.accent).border }}>
				...
				<section className="mb-8 rounded-2xl p-4 bg-gray-950/10 backdrop-blur-sm border border-white/10 shadow-[0_10px_30px_rgba(0,0,0,0.25)]">
					<h3 className="mb-4 text-center text-base font-semibold text-gray-900">Как это работает</h3>
				...
				<AnimatePresence>{isFaqOpen && <FaqModal onClose={() => setIsFaqOpen(false)} />}</AnimatePresence>
			</div>
		</div>
	);
}
